...
css () {
    ...
    cat ./src/stylesheets/desktop/*.scss ./src/stylesheets/shared/*.scss > ./public/stylesheets/desktop.css
    echo "Bundling mobile css files"
    cat ./src/stylesheets/mobile/*.scss ./src/stylesheets/shared/*.scss > ./public/stylesheets/mobile.css
}
